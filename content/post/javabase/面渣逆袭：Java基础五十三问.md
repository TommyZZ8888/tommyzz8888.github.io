...
大家好，我是老三， [面渣逆袭](https://mp.weixin.qq.com/mp/appmsgalbum?__biz=MzkwODE5ODM0Ng==&action=getalbum&album_id=2041709347461709827&scene=173&from_msgid=2247489004&from_itemidx=1&count=3&nolastread=1#wechat_redirect) 系列继续。这节我们回到梦开始的地方——Java基础，其实过了萌新阶段，面试问基础就问的不多，但是保不齐突然问一下。想一下，总不能张口高并发、闭口分布式，结果什么是面向对象，说不清，那多少有点魔幻。所以赶紧来看看，这些基础有没有你不会的！
...
![下辈子还学Java](/img/javabase/base/20220115100150.png)
...
![Java语言特点](/img/javabase/base/20220115102217.png)
...
![JDK、JRE、JVM关系](/img/javabase/base/20220115103315.png)
...
![Java程序执行过程](/img/javabase/base/20220115104405.png)
...
![编译与解释](/img/javabase/base/20220115104257.png)
...
![Java数据类型](/img/javabase/base/20220115125651.png)
...
![Java自动类型转换方向](/img/javabase/base/20220115191949.png)
...
![装箱和拆箱](/img/javabase/base/20220115193443.png)
...
![break 、continue 、return](/img/javabase/base/20220115195245.png)
...
![面向对象和面向过程的区别](/img/javabase/base/20220115203351.png)

### 16.面向对象有哪些特性

![面向对象三大特征](/img/javabase/base/20220115203617.png)
...
![访问修饰符和可见性](/img/javabase/base/20220115215058.png)
...
*   被final修饰的变量不可变，被final修饰的变量必须被显式第指定初始值，还得注意的是，这里的不可变指的是变量的引用不可变，不是引用指向的内容的不可变。
    ...
    ![final修饰变量](/img/javabase/base/20220116212446.png)
...
![Java引用数据值传递示意图](/img/javabase/base/20220116220451.png)
...
![浅拷贝和深拷贝示意图](/img/javabase/base/20220116222517.png)
...
![Java创建对象的四种方式](/img/javabase/base/20220116223506.png)
...
![堆与常量池中的String](/img/javabase/base/20220116230542.png)
...
![jdk1.8之前的字符串拼接](/img/javabase/base/20220117085549.png)
...
![Integer.valueOf](/img/javabase/base/20220117230058.png)
...
![parseInt示意图](/img/javabase/base/20220118073051.png)
...
![Object类的方法](/img/javabase/base/20220118075626.png)
...
![Java异常体系](/img/javabase/base/20220118083050.png)
...
![异常处理](/img/javabase/base/20220118084205.png)
...
![IO-操作方式分类-图片来源参考[2]](/img/javabase/base/20211011215419.jpeg)
...
![Java IO流用到装饰器模式](/img/javabase/base/20220118224856.png)
...
![BIO、NIO、AIO](/img/javabase/base/20220119001928.png)
...
![BIO、NIO、AIO](/img/javabase/base/20220119004611.png)
...
![NIO线程](/img/javabase/base/20220119004630.png)

NIO的数据是面向**缓冲区Buffer**的，必须从Buffer中读取或写入。

所以完整的NIO示意图：

![NIO完整示意图](/img/javabase/base/20220119005251.png)
...
![序列化和反序列化](/img/javabase/base/20220120094441.png)
...
![Java常见序列化方式](/img/javabase/base/20220120095418.png)
...
![泛型类、泛型接口、泛型方法](/img/javabase/base/20220121091637.png)
...
![Java注解和帽子](/img/javabase/base/20220121085537.png)
...
![Override注解](/img/javabase/base/20220121090438.png)
...
![Autowired注解](/img/javabase/base/20220121090608.png)
...
![Java反射相关类](/img/javabase/base/20220121220853.png)
...
![JDK1.8主要新特性](/img/javabase/base/20220121223429.png)
...
![Java Stream流](/img/javabase/base/20220121232729.png)
...
![](/img/javabase/base/1659274-20220124214709248-441069911.png)
