...
Open[Feign](https://so.csdn.net/so/search?q=Feign) 是 Spring Cloud 全家桶的组件之一， 其核心的作用是为 Rest [API](https://so.csdn.net/so/search?q=API&spm=1001.2101.3001.7020) 提供高效简洁的 RPC 调用方式
