...
![image](/img/db/mysql/2345397-20220220162614805-910847939.png)

### 1.1数据库文件的存放路径

MySQL数据库文件的存放路径：/var/lib/mysql/  
![image](/img/db/mysql/2345397-20220220163111437-1807887880.png)

### 1.2相关命令的存放路径

相关命令目录：/usr/bin和/usr/sbin。  
**/usr/bin目录**  
![image](/img/db/mysql/2345397-20220220163537093-646907271.png)  
**/usr/sbin目录**  
![image](/img/db/mysql/2345397-20220220163652279-1335793189.png)  
**启动命令能读取的配置文件选项组**  
![image](/img/db/mysql/2345397-20220220175719237-1534110880.png)

### 1.3配置文件目录

配置文件目录：/usr/share/mysql（命令及配置文件）和 /etc（如my.cnf）  
**/usr/share/mysql（命令及配置文件）**  
![image](/img/db/mysql/2345397-20220220163915839-1761112202.png)  
**/etc目录**  
![image](/img/db/mysql/2345397-20220220164107873-1172310117.png)
...
查看命令：SHOW DATABASES;  
![image](/img/db/mysql/2345397-20220220164808378-314876593.png)
...
![image](/img/db/mysql/2345397-20220220165921881-726155399.png)
